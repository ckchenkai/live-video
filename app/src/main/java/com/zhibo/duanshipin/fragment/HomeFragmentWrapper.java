...
public class HomeFragmentWrapper extends BaseLazyFragment {
    private static final String FRAGMENT_NAME = "fragment_name";
    private String fragmentName;
    private FragmentActivity mActivity;
    private FragmentManager fragmentManager;
    private Fragment fragment;
    public static HomeFragmentWrapper newInstance(String fragmentName) {
        HomeFragmentWrapper fragmentWrapper = new HomeFragmentWrapper();
    ...
    protected void onLazyLoad() {
        ...
        transaction.add(R.id.home_wrapper_container,fragment);
        transaction.commit();
    }
