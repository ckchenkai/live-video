...
import com.zhibo.duanshipin.bean.VersionJsonNode;
...
public class UpgradeManager {
    ...
    public UpgradeManager(Context home, Context context, boolean isForceShow) {
        mContext = context;
...
//        VersionJsonNode.Request(mContext, this, 0);
        ...
        map.put("sys", "1");
        OkHttpUtil.getInstance().doAsyncPost(Consts.BASE_URL + "c=Index&a=public_version", map, new OkHttpCallback() {
            @Override
            public void onSuccess(String response) {
                ...
                try {
                    ...
                    if (mVersionJsonNode != null) {
                        ...
                        if (!Utils.getLocalVersion(mContext).equals(mVersionJsonNode.getData().getVersion().getVcode())) {
            ...
            switch (msg.what) {
                ...
                case FINISH: {
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                        ...
                        Uri contentUri = FileProvider.getUriForFile(App, "com.zhibo.duanshipin.provider", file);
